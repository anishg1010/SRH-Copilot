"""Capability tools for the HR Compliance Agent — TODO.

Follow the pattern in agents/teaching/tools.py: each tool retrieves grounding from the
'hr_compliance' collection via `retrieve("hr_compliance", query)`, then returns a focused task brief
